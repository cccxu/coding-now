...
public interface UserInfoDao {
    ...
    String NEW_USER_INFO = " user_id, user_nick_name, head_pic, email, gender, phone_number, member_points ";

    @Insert({"INSERT INTO ", TABLE_NAME, "(", NEW_USER_INFO, ")" +
            " values (#{userId}, #{userNickName}, #{headPic}, #{email}, #{gender}, #{phoneNumber}, #{memberPoints})"})
